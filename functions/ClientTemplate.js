const ClientTemplate = (selectedSlot, code, expiryDateTime, email, userId) => {
        ...
        <html lang="en">
          ...
          <body>
            <div class="container">
              ...
              <p><b>Selected Slot:</b> ${selectedSlot}</p>
              <p><b>Your Code:</b> ${code}</p>
              <p><b>Code Expiry:</b> ${expiryDateTime}</p>
              <p><b>Your Email:</b> ${email}</p>
              <p><b>Link To Confirm your Slot:</b> <a href="https://clerkenwell-bio-botanics.co.uk/ticket" target="_blank">https://clerkenwell-bio-botanics.co.uk/ticket</a></p>
              <br/>
